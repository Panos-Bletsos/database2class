...
class Database
{
    ...
    public $persistentconn;       // Where to log errors (optional)
    public $lastinsertid; // Whether to use persistent connections.
    private $logfile;   // ID of last record inserted, if we ever did.
